...
export default function WeddingCity() {
    ...
    const calculateTotalCost = () => {
        ...
        const additionalServicesCost = eventdata.reduce((acc, event, index) => {
            const additionalServiceName = `eventName-${index}`;
            const additionalServiceQuantity = formData[additionalServiceName] || 0;
            const additionalServicePrice = event.price || 0;
    
            return acc + additionalServiceQuantity * additionalServicePrice;
        }, 0);
