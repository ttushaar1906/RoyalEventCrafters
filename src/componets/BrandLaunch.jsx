...
const [selectedOption, setSelectedOption] = useState("");
  ...
  return (
    ...
    <div className="linking-tags">
        <Link to="/Home">Home </Link> <FontAwesomeIcon icon={faArrowRight} size="xs" style={{ color: "#000000", }} /> <Link to="/RoyalEvent">RoyalEvents</Link> <FontAwesomeIcon icon={faArrowRight} size="xs" style={{ color: "#000000", }} /><Link to="/RoyalEvent/BrandLaunch">BrandLaunch</Link>
    </div>
    <h1 className="lg-heading wed-heads">"Elevate your brand with a grand launch event! Join us for an unforgettable unveiling.".</h1>
